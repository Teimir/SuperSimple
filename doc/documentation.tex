...
│
├── Примеры
│   └── test_examples/       # Тестовые примеры программ
...
│       ├── math_test/       # Тестирование математических библиотек
│       ├── uart_message/     # Примеры вывода сообщений через UART
│       ├── uart_number/     # Примеры вывода чисел через UART
